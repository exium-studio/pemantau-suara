...
import SelectUser from "../dependent/dedicated/SelectUser";
...
export default function SaksiForm({
  ...
  const formik = useFormik({
    ...
    validationSchema: yup.object().shape({
      ...
      status_aktivitas: !excludeFields?.includes("status_aktivitas")
        ? yup.object().required("Harus diisi")
        : yup.mixed(),
      tps: yup.number().required("Harus diisi"),
  ...
  return (
    <>
      <form id="activityForm" onSubmit={formik.handleSubmit}>
        ...
        {/* Potensi Suara */}
        <FormControl mb={4} isInvalid={!!formik.errors?.tps}>
          <FormLabel>
            TPS
            <RequiredForm />
          </FormLabel>
          <NumberInput
            ...
            onChangeSetter={(input) => {
              formik.setFieldValue("tps", input);
            }}
            isError={!!formik.errors.tps}
            inputValue={formik.values.tps}
          />
          <FormErrorMessage>{formik.errors.tps as string}</FormErrorMessage>
        </FormControl>
        ...
        <FormControl mb={4} isInvalid={!!formik.errors?.deskripsi}>
          ...
          <Textarea
            ...
            placeholder="Tulis Deskripsi Saksi"
          />
          <FormErrorMessage>
